...
and the final decision on contributions will be made by [the current editor]({{site.author.url}});
...
please [get in touch]({{site.author.email}});
...
1. When you are done, create a pull request from your repository to [this one]({{site.repositoryurl}})
   and [email us](({{site.author.email}}) to let us know your post is ready for review.
...
1. Replace *Your Name* with the name you would like to appear in the review.
   ...
   [get in touch]({{site.author.email}}) if you want to do this.
